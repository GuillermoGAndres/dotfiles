...
export ANT_HOME=~/bin/apache-ant-1.9.15/
export M2_HOME=$HOME/bin/apache-maven-3.6.3
export VSC_HOME=$HOME/bin/VSCode-linux-x64
export PATH=$HOME/bin:/usr/local/bin:$PATH:$HOME/Downloads/clangd_10.0.0/bin:${ANT_HOME}bin:$M2_HOME/bin:$VSC_HOME/bin
...
# ----------------------------------------
# Mi prompt
#PROMPT='%B%F{blue}%n%f%b%B%F{cyan}@%f%b%B%F{229}%M%f%b %B%F{216}%1~% %f%b %F{cyan}%#%f $(git_prompt_info)'
#PROMPT='[%F{yellow}%M%f%F{cyan}@%f%F{blue}%n%f %F{216}%1~%f] %F{cyan}%#%f $(git_prompt_info)'
...
alias runServerLampp="/opt/lampp/manager-linux-x64.run &"
# alias g++="g++ -pipe -O2 -std=c++11 -Wall -g"
#Tags:
#	 -v: verbose mode
